...
return [
    ...
    */
    'path' => [
        ...
        'url' => [
            "user" => $uploadsUrlPath . "user/",
            "recipe" => $uploadsUrlPath . "recipe/",
            "history" => $uploadsUrlPath . "history/",
            // Add more paths if needed
        ],
        //Storage Document Paths [Eg. store image]
        // /var/www/html/projectname/storage/
        'storage' => [
            "user" => $uploadsStorePath . "user/",
            "recipe" => $uploadsStorePath . "recipe/",
            "history" => $uploadsStorePath . "history/",
            // Add more paths if needed
        ],
        // 'api' => [
        //     "slider" => $uploadsStorePathApi . "slider/",
        //     "member" => $uploadsStorePathApi . "member/",
        //     "history" => $uploadsStorePathApi . "history/",
        //     // Add more paths if needed
        // ],
