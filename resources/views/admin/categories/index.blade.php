...
@section('content')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="#" class="btn btn-sm fw-bold btn-primary" id="modal_show_categories">Add Category</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
            ...
            <div class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5  mb-0 categories-data-listing">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
    ...
    <div class="modal fade show" tabindex="-1" id="kt_modal_categories"aria-modal="true" role="dialog">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content blockui" id="kt_block_ui_categories_target" style="">
                ...
                <div class="modal-body py-lg-10 px-lg-20">
                    <!--begin:Form-->
                    <form id="add_categories_details" class="form">
                        @csrf
                        @method('PUT')
                        @method('POST')
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" value="0"
                                            id="categories_type" name='categories_type' checked />
                                        <label class="form-check-label" for="categories_type">
                                            Parent &ensp;&ensp;&ensp;
                                        </label>
                                    </div>
                                    <!--end::Option-->
                                    <!--begin::Option-->
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" value="1"
                                            id="categories_type2" name='categories_type' />
                                        <label class="form-check-label" for="categories_type2">
                                            Child &ensp;&ensp;&ensp;
                                        </label>
                                    </div>
                                    <!--end::Option-->
                                </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" value="0"
                                            id="categories_status" name='categories_status' checked />
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" value="1"
                                            id="categories_status2" name='categories_status' />
                                        <label class="form-check-label" for="categories_status2">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="categories_name" id="categories_name"
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label fw-semibold fs-6" id="child_category_label"></label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <!--begin::Row-->
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="col-lg-12 fv-row" id="child_category_dropdown" style="display: none;">
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                            id='category_parent' name='category_parent' data-placeholder="Select option">
                                            <option value='' disabled selected>Select Option</option>
                        ...
                        <div class="text-center mt-10">
                            ...
                            <button type="submit" class="btn btn-primary" id="kt_block_ui_categories_button">Add
                                Category</button>
                        </div>
                        <!--end::Actions-->
                    </form>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            // console.log($(document).attr('data-bs-theme'));
            ...
            function fetchCategories() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var selectElement = $('#category_parent');
                        selectElement.empty();
                        selectElement.append(
                            '<option value="" disabled selected>Select Option</option>');
                        for (var i = 0; i < response.length; i++) {
                            var category = response[i];
                            selectElement.append('<option value="' + category.id + '">' + category
                                .name + '</option>');
                        }
            ...
            // $('#child_category_label').html('Parent Category').addClass('required');
            // $('#child_category_dropdown').css('display', 'block');
            $('#child_category_label').html(' ').removeClass('required');
            $('#child_category_dropdown').css('display', 'none');

            $('#categories_type').click(function(e) {
                $('#child_category_label').html(' ').removeClass('required');
                $('#child_category_dropdown').css('display', 'none');
            });
            $('#categories_type2').click(function(e) {
                fetchCategories();
                $('#child_category_label').html('Parent Category').addClass('required');
                $('#child_category_dropdown').css('display', 'block');

            });
            var oTable = $('.categories-data-listing').DataTable({
                ...
                "ajax": {
                    "url": "{!! $module_route . '/get-categories-details' !!}",
                    "data": function(d) {
                        d.status = $('#status').val();
                ...
                columns: [{
                        data: null,
                        // name: 'id',
                        className: "categories-id text-center",
                        render: function(o) {
                            var data;
            ...
            $(document).on('click', '.toggleStatus', function() {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ route('categories_changeStatus') }}",
                    data: {
                        id: id,
                        status: status
                    },
            ...
            $('#modal_show_categories').click(function(e) {
                ...
                $('#kt_modal_categories').modal('show');
            });
            ...
            $(document).on('click', '.editRecord', function(e) {
                ...
                $.ajax({
                    type: "get",
                    url: "{!! $module_route . '/categories' !!}/" + id + "/edit",
                    success: function(response) {
                        // console.log(response);
                        if (response.status == 'success') {
                            $('.modal-title').html("Edit Category");
                            $('#kt_block_ui_categories_button').html(
                                "Update Category"); // Change button text

                            $('#categories_name').val(response.data.name);

                            if (response.data.parent_category_id == null) {
                                $('#categories_type[value="0"]').prop('checked', true);
                                $('#categories_type2[value="1"]').prop('checked', false);
                                $('#child_category_label').html(' ').removeClass('required');
                                $('#child_category_dropdown').css('display', 'none');
                            } else {
                                $('#child_category_label').html('Parent Category').addClass(
                                    'required');
                                $('#child_category_dropdown').css('display', 'block');
                                $('#categories_type[value="0"]').prop('checked', false);
                                $('#categories_type2[value="1"]').prop('checked', true);
                                // console.log('Setting parent category value...' + response.data.parent_category_id);
                                $('#category_parent').val(response.data.parent_category_id);
                            }
                            if (response.data.status == 0) {
                                $('#categories_status[value="0"]').prop('checked', true);
                                $('#categories_status2[value="1"]').prop('checked', false);
                            } else {
                                $('#categories_status[value="0"]').prop('checked', false);
                                $('#categories_status2[value="1"]').prop('checked', true);
                            }
                            $('#kt_modal_categories').data('update_id', response.data.id);
            ...
            var button = document.querySelector("#kt_block_ui_categories_button");
            var target = document.querySelector("#kt_block_ui_categories_target");
            ...
            button.addEventListener("click", function(e) {
                ...
                var updateId = $('#kt_modal_categories').data('update_id');
                var formAction;
                var formData = new FormData();

                if (updateId) {
                    formAction = "{!! $module_route . '/categories' !!}/" + updateId;
                    formData.append('_method', $('input[name="_method"]').val());
                } else {
                    formAction =
                        "{{ route('categories.store') }}"; // Default action for adding a categories
                }
                formData.append('categories_type', $('input[name="categories_type"]:checked').val());
                formData.append('categories_status', $('input[name="categories_status"]:checked').val());
                formData.append('categories_name', $('#categories_name').val());
                formData.append('parent_category_id', $('#category_parent').val());
                ...
                $.ajax({
                    ...
                    url: formAction,
                    data: formData,
                    // data: $('#add_categories_details').serialize(),
                    processData: false,
                    contentType: false,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    ...
                    success: function(response) {
                        if (response.status == 'success') {
                            $("#kt_modal_categories").modal('hide');
                            toastcall('success', response.message);
                            $('#add_categories_details')[0].reset();
                            oTable.draw();
                        } else {
                            toastcall('error', response.message);
                        }
            ...
            $('#kt_modal_categories').on('hidden.bs.modal', function() {
                $('.modal-title').html("Add Category");
                $('#kt_block_ui_categories_button').html("Add Category");
                $('#kt_modal_categories').removeData('update_id'); // Clear update_id data attribute
