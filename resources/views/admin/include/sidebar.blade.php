<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <!--begin::Logo image-->
        {{-- <a href="."  > --}}
        {{-- <h1 class="text-center" style="color: white;">FLAVOUR QUEST</h1> --}}
        <h1 class="ms-7 app-sidebar-logo-default" style="color: white;">Flavour<span style="color: yellow;">Quest</span>
        </h1>
        <h1 class="app-sidebar-logo-minimize" style="color: white;">F<span style="color: yellow;">Q</span></h1>
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ isActiveRoute('admin_dashboard') }}" href="{{ route('admin_dashboard') }}">
                ...
                {{-- <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ isActiveRoute('user.index') }}" href="{{ route('user.index') }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ isActiveRoute('categories.index') }}"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ isActiveRoute('ingredients.index') }}"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ isActiveRoute(['recipes.index', 'recipes.create', 'recipes.edit']) }}"
