        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('recipes.create') }}" class="btn btn-sm fw-bold btn-primary" id="modal_show">Add
                        Recipes</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5  mb-0 data-listing">
                            ...
                            <thead>
                                ...
                                <tr class="text-center text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-200px">Recipe Name</th>
                                    <th class="min-w-150px">Level</th>
                                    <th class="min-w-150px">Contain Egg</th>
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('.data-listing').DataTable({
                ...
                columns: [{
                        ...
                        render: function(o) {
                            ...
                            data = '<a target="_blank" href="{!! $module_route !!}/recipes/' +id + '">' +
                                paddedId + '</a>';
                            return data;
                    ...
                    },
                    {
                        ...
                        render: function(s) {
                            return '<div class="d-flex align-items-center"><div class="symbol symbol-50px overflow-hidden me-3">' +
                                (s.image !== null ?
                                    '<a href="' +
                                    "{{ Storage::url(config('filesystems.path.url.recipe')) }}" + s
                                    .image +
                    ...
                    },
                    {
                        ...
                        name: null,
                        render: function(s) {
                            var value = s.contain_egg == 0 ? 'No' : 'Yes';
                            return value;
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        render: function(o) {
                            ...
                            btnStr +=
                                '<a href="{!! $module_route !!}/recipes/' + o.id +
                                '/edit" target="_blank" class="btn btn-icon btn-active-color-primary w-30px h-30px " data-bs-toggle="tooltip" data-bs-custom-class title="Edit" val="' +
                                o.id +
            ...
            $(document).on('click', '.toggleStatus', function() {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ route('recipes_changeStatus') }}",
                    data: {
                        id: id,
                        status: status
                    },
